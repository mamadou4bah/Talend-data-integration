...
----------------------------------------------------------------------------
---------- Table dimensionnelle N°2 : "VENTE_DWH"."DIM_CALENDRIER" ---------
----------------------------------------------------------------------------
...
----------------------------------------------------------------------------
------------------- Table N°3 : "DEPENSE_DWH"."FAIT_DEPENSE" ----------------
----------------------------------------------------------------------------
...
(
	...
	CONSTRAINT "FAIT_DEPENSE_SC_FKEY" FOREIGN KEY ("ID_DIM_SOUS_CATEGORIE") REFERENCES "DIM_SOUS_CATEGORIE" ("ID_DIM_SOUS_CATEGORIE"),	
	CONSTRAINT "FAIT_DEPENSE_CALENDRIER_FKEY" FOREIGN KEY ("ID_DIM_CALENDRIER") REFERENCES "DIM_CALENDRIER" ("ID_DIM_CALENDRIER")	
);